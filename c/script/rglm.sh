...
REGAB_CMD="unbuffer -p $REGAB -v --action extract"
...
RGLM_CMD="unbuffer -p $RGLM --verbose --solve"
...
RGLM_EXT_CMD="unbuffer -p $RGLM --verbose --input-file $RGLM_OUT"
...
RGLMW_W_CMD="unbuffer -p $RGLMW --verbose --weights-file $RGLM_EXT_w"
RGLMW_W_CMD+=" --extract-weights $RGLMW_EXT_W"
RGLMW_W_CMD+=" 2>&1 | tee $RGLMW_EXT_LOG"

RGLMW_P_CMD="unbuffer -p $RGLMW --verbose --weights-file $RGLM_EXT_w"
RGLMW_P_CMD+=" --positions-file $RGLM_OUT"
RGLMW_P_CMD+=" --extract-positions $RGLMW_EXT_P"
RGLMW_P_CMD+=" 2>&1 | tee -a $RGLMW_EXT_LOG"

RGLMW_C_CMD="unbuffer -p $RGLMW --verbose --weights-file $RGLM_EXT_w"
RGLMW_C_CMD+=" --positions-file $RGLM_OUT"
