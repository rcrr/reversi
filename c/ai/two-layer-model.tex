...
\include{tlm_intro}
\include{tlm_rappresentazione_del_dominio}
\include{tlm_game_positions}
\include{tlm_definizioni_python}
\include{tlm_geometria_della_board}
\include{tlm_teoria_dei_pattern}
\include{tlm_definizione_e_calcolo_dei_pattern}
\include{tlm_evaluation_function}

\appendix

\include{tlm_appendix_catalogo_dei_pattern}
