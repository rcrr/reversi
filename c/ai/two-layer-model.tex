...
%
% TO-DO
% - I capitoli che spiegano la definizione dei Pattern sono completi, ma vanno riorganizzati.
...
\usepackage[T1]{fontenc} % Use 8-bit encoding for better font handling
\usepackage{lmodern}      % Allow fonts to scale to any size (like 3pt)
...
\usepackage{etoolbox} % Necessario per \patchcmd o \StrSubstitute
\usepackage[strings]{underscore} % Gestisce automaticamente gli underscore ovunque
...
\includeonly{tlm_00_intro,tlm_07_evaluation_function}

% Usato nella appendice 08
...
%
% Premere poi il tasto ` ( sotto esc, a sinistra del tasto 1 )
%
...
\include{tlm_00_intro}
\include{tlm_01_rappresentazione_del_dominio}
\include{tlm_02_game_positions}
\include{tlm_03_definizioni_python}
\include{tlm_04_geometria_della_board}
\include{tlm_05_teoria_dei_pattern}
\include{tlm_06_definizione_e_calcolo_dei_pattern}
\include{tlm_07_evaluation_function}

\appendix

\include{tlm_08_appendix_catalogo_dei_pattern}
