...
[Pattern: name = ZSHAPE, mask = 0x0000000c30000000]
  [n_squares = 4, n_configurations = 81, n_instances = 4, n_stabilizers = 2]
  Cells:               [E4, F4, C5, D5]
  Transformed masks:   
...
[Pattern: name = ELLE, mask = 0x0000000000000107]
  [n_squares = 4, n_configurations = 81, n_instances = 8, n_stabilizers = 1]
  Cells:               [A1, B1, C1, A2]
  Transformed masks:   
...
[Pattern: name = EDGE, mask = 0x00000000000000ff]
  [n_squares = 8, n_configurations = 6561, n_instances = 4, n_stabilizers = 2]
...
[Pattern: name = RCT2X4, mask = 0x0000003c3c000000]
  [n_squares = 8, n_configurations = 6561, n_instances = 2, n_stabilizers = 4]
...
[Pattern: name = BARBEL, mask = 0x030304081020C0C0]
  [n_squares = 12, n_configurations = 531441, n_instances = 2, n_stabilizers = 4]
...
[Pattern: name = DIAG3, mask = 0x0000000000010204]
  [n_squares = 3, n_configurations = 27, n_instances = 4, n_stabilizers = 2]
  Cells:               [C1, B2, A3]
  Transformed masks:   
