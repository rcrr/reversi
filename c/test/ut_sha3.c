      ...
      char **argv)
{
  ...
  ut_suite_add_simple_test(s, UT_MODE_STND, UT_QUICKNESS_001,  "sha3_256_1M_a_0", sha3_256_1M_a_0_t);
  ut_suite_add_simple_test(s, UT_MODE_STND, UT_QUICKNESS_001,  "sha3_256_1M_a_1", sha3_256_1M_a_1_t);
