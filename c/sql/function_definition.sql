...
DECLARE
  ...
  zobrist_bitstrings CONSTANT BIGINT[] := array[
    (x'0x4EC764D9D2FC995C')::BIGINT, (x'0x4689879C5E2B6C8D')::BIGINT, (x'0x7B8509672627BDE6')::BIGINT, (x'0x5EC9EED7E83A1070')::BIGINT,
    (x'0x8C61E367C148A670')::BIGINT, (x'0x12BF65D47CB500F3')::BIGINT, (x'0x2D128CD312314B15')::BIGINT, (x'0xEC8FFA579C3FF006')::BIGINT,
    (x'0x1B772E0C17A8637D')::BIGINT, (x'0xFEA5D5093AE4F127')::BIGINT, (x'0x3F6223B7D74731E8')::BIGINT, (x'0x9BF6F10BF080F403')::BIGINT,
    (x'0xCE03618789AACB66')::BIGINT, (x'0x29264F46A5C844E3')::BIGINT, (x'0xD4BD485D4B88FC6E')::BIGINT, (x'0xAAC3C81799DAE8F5')::BIGINT,
    (x'0x46B256D2079DA270')::BIGINT, (x'0x5765CB86D7BE25B4')::BIGINT, (x'0x7754057541AAAF9E')::BIGINT, (x'0xB9E9E765C5214D6D')::BIGINT,
    (x'0x957833AE886E5003')::BIGINT, (x'0x59BEDBE41933BEB6')::BIGINT, (x'0xD5D328EC1AE90B22')::BIGINT, (x'0x26FA194CD5A4CC9A')::BIGINT,
    (x'0x34790BFC50B7571E')::BIGINT, (x'0xE91BC0D61C9FA3C5')::BIGINT, (x'0x8FB89136550EFB06')::BIGINT, (x'0x36701B34D43E30CD')::BIGINT,
    (x'0xAAFD6ACF34BB27C1')::BIGINT, (x'0x401DD1B2B7A72AB4')::BIGINT, (x'0x6F5903B64BBD50D7')::BIGINT, (x'0x9067F2A3CB7EBB34')::BIGINT,
    (x'0x2C7807F6E28CD962')::BIGINT, (x'0x42B2DB1AED17AFD5')::BIGINT, (x'0xF42857186A09F927')::BIGINT, (x'0x258AB4C5E9986E0C')::BIGINT,
    (x'0x8F8BA0BC0571B0F6')::BIGINT, (x'0xCB7AC29208905214')::BIGINT, (x'0x89914660AA38896A')::BIGINT, (x'0x380CAC8536886A07')::BIGINT,
    (x'0x7B7F399C6EC9563D')::BIGINT, (x'0xB9CBFBEEE95F05B1')::BIGINT, (x'0x46AAAFC2159C8F19')::BIGINT, (x'0xDCE680A0882BCCEF')::BIGINT,
    (x'0x347DDA36E42E2D99')::BIGINT, (x'0x48EAF8CB224BCBB6')::BIGINT, (x'0x1EACE389084B2674')::BIGINT, (x'0x261BC842C735974D')::BIGINT,
    (x'0xF334875975FD986B')::BIGINT, (x'0xF6B436CC3615018C')::BIGINT, (x'0x6658B92BCD930893')::BIGINT, (x'0x4B6BF5B88078852E')::BIGINT,
    (x'0x30461B28416207E1')::BIGINT, (x'0xA2EE71D448670786')::BIGINT, (x'0x0C8CD31138E8A683')::BIGINT, (x'0x5FF41A78E0014DD0')::BIGINT,
    (x'0xA57DE5B0A848A8E0')::BIGINT, (x'0x71D68A3A9600F975')::BIGINT, (x'0xEBB35D1E75B69FFB')::BIGINT, (x'0xFCC1D327A771464B')::BIGINT,
    (x'0xB6C1F45DB043CF56')::BIGINT, (x'0x92EF77063313F3CE')::BIGINT, (x'0x5F48E97C72B167E2')::BIGINT, (x'0x5806342E75C7BB6B')::BIGINT,
    (x'0x056C0070CF70F8DD')::BIGINT, (x'0x81AD4662EE05E75A')::BIGINT, (x'0x1C10E0B05C7B3C49')::BIGINT, (x'0xC684C383E396972A')::BIGINT,
    (x'0x35747D859FC1A7E1')::BIGINT, (x'0xFDDCF0169427CEE5')::BIGINT, (x'0x3952CBE313B377E2')::BIGINT, (x'0xDA1B5C1E5BCCB131')::BIGINT,
    (x'0x10B747061AF1559C')::BIGINT, (x'0x8388EDE0F8EDCBFC')::BIGINT, (x'0x4873A84B8ABF0FA8')::BIGINT, (x'0xB30E990FE793A807')::BIGINT,
    (x'0x6B8C5C09C78D0A9F')::BIGINT, (x'0x7A488BC144D344AA')::BIGINT, (x'0xC04C26EC10A73AE9')::BIGINT, (x'0x9278CDFF5EBA539E')::BIGINT,
    (x'0xFF3A1C4370FB8703')::BIGINT, (x'0x70D16AE16E34B5B5')::BIGINT, (x'0x2732FCB913E2E5C3')::BIGINT, (x'0xC59EE008F48EB1FA')::BIGINT,
    (x'0x38C7DB9E584C3680')::BIGINT, (x'0x16F9194953701E88')::BIGINT, (x'0x2E4C5FAC8051C8FD')::BIGINT, (x'0x27DD41B7B5D864FA')::BIGINT,
    (x'0xECA6A65750A55AEA')::BIGINT, (x'0x5EBECF093FF380E7')::BIGINT, (x'0xAA4B94B2F0585B82')::BIGINT, (x'0xC88047DA71E83C4D')::BIGINT,
    (x'0xB55C0550FE29B255')::BIGINT, (x'0x2A1F8CB7ECEB6200')::BIGINT, (x'0x7B841E8CB0945F2D')::BIGINT, (x'0x6E5D5D9ED39B4961')::BIGINT,
    (x'0x67222624CF379C81')::BIGINT, (x'0x0CC24C31A8BA7F90')::BIGINT, (x'0x4B54A89AF4A4DF4C')::BIGINT, (x'0x91A6E548CAC3E417')::BIGINT,
    (x'0x83DEB6121EA84F96')::BIGINT, (x'0x9F951DD98DBB9DF5')::BIGINT, (x'0x25584291FF15CB27')::BIGINT, (x'0x3371E38504F0CB1F')::BIGINT,
    (x'0x0EB9B65B5DE9637D')::BIGINT, (x'0x2D292615860C0AE9')::BIGINT, (x'0x8DAFEA0E2F5DD418')::BIGINT, (x'0x5E30A0DFD3A6BA54')::BIGINT,
    (x'0x5C442D0B47BF7364')::BIGINT, (x'0x7C2EEBB8C8734B16')::BIGINT, (x'0x440AF7B361B686A6')::BIGINT, (x'0xBC6C2CB56CE41EDD')::BIGINT,
    (x'0x2DF7B73E01F1DB6C')::BIGINT, (x'0xD76592C6235F3FFE')::BIGINT, (x'0x2139DC845CE8D2B0')::BIGINT, (x'0x42168DFAFC8BF871')::BIGINT,
    (x'0xB0E6598E3C707763')::BIGINT, (x'0xD7C55A777BF74808')::BIGINT, (x'0x04C0175493D0C6EC')::BIGINT, (x'0x78B2B49BF53DD1A5')::BIGINT,
    (x'0xC6020A48A9F0B2CD')::BIGINT, (x'0x08CA89D2EA10FEB4')::BIGINT, (x'0x07DE9D1304C3B2BD')::BIGINT, (x'0x769EF9C4E120BC5F')::BIGINT,
    (x'0xEEBD5772D344846F')::BIGINT, (x'0x1E972C3F168BBF7F')::BIGINT, (x'0x0C72560FAD1EC422')::BIGINT, (x'0xD85B15F5DBCD19B9')::BIGINT
  ];
