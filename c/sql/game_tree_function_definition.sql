...
--
CREATE OR REPLACE FUNCTION gt_load_from_staging (    engine_id           CHAR(10),
                                                     description         TEXT,
                                                 OUT new_run_id          INTEGER,
                                                 OUT record_loaded_count INTEGER)
AS $$
BEGIN
  INSERT INTO game_tree_log_header (engine_id, run_date, description) VALUES (engine_id, now(), description) RETURNING run_id INTO new_run_id;
