...
BEGIN
  ...
  INSERT INTO game_tree_log (run_id, sub_run_id, call_id, hash, parent_hash, blacks, whites, player, alpha, beta, call_level, empty_count, is_leaf, legal_move_count, legal_move_count_adjusted, parent_move, t_call_cnt, t_alpha, t_best_move, t_searched_move_cnt, legal_move_array, t_searched_move_array)
    SELECT new_run_id, sub_run_id, call_id, hash, parent_hash, blacks, whites, player, alpha, beta, call_level, empty_count, is_leaf, legal_move_count, legal_move_count_adjusted, parent_move, t_call_cnt, t_alpha, t_best_move, t_searched_move_cnt, legal_move_array, t_searched_move_array FROM game_tree_log_staging;
