...
VACUUM(FULL, ANALYZE) game_tree_log;
SELECT p_assert(gt_check('T003', 0) = (3364, 1827, 1827, 2126, 0, 1537, 0, 1, 958), 'The game tree T003/0 has not been loaded as expected.');
...
FROM
  game_position_test_data WHERE id = 'ffo-01-simplified-4';
VACUUM(FULL, ANALYZE) game_tree_log;
SELECT p_assert(gt_check('T004', 0) = (3364, 1827, 1827, 2126, 0, 1537, 0, 1, 958), 'The game tree T004/0 has not been loaded as expected.');
