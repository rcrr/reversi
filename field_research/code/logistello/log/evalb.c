...
WERT EvalBSlow(BRETT *pb, PARTEI player)
{
...
Error("slow not supported");
  ...
  cout << "val2=" << patt_val(pt, player, P10(A8,B8,C8,D8,E8,A7,B7,C7,D7,E7)) << endl;
  cout << "val2=" << patt_val(pt, player, P10(H8,G8,F8,E8,D8,H7,G7,F7,E7,D7)) << endl;
  cout << "val2=" << patt_val(pt, player, P10(A1,A2,A3,A4,A5,B1,B2,B3,B4,B5)) << endl;
  cout << "val2=" << patt_val(pt, player, P10(H1,H2,H3,H4,H5,G1,G2,G3,G4,G5)) << endl;
  cout << "val2=" << patt_val(pt, player, P10(A8,A7,A6,A5,A4,B8,B7,B6,B5,B4)) << endl;
  cout << "val2=" << patt_val(pt, player, P10(H8,H7,H6,H5,H4,G8,G7,G6,G5,G4)) << endl;
  cout << ">>>" << isu << endl;
#endif
...
WERT EvalB(BRETT *pb, PARTEI player)
{
